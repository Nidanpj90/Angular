...
export class ClientesService {
  ...
  constructor(private http : HttpClient) { 
    this.clientes=[
      {nombre:"Pepe", id:22, direccion:"La Paz", grupo:2, nif:"3333H"},
      {nombre:"Ana", id:24, direccion:"La Santa", grupo:2, nif:"2222H"},
      {nombre:"Juan", id:28, direccion:"La Cruz", grupo:2, nif:"1111H"}
    ];
    this.grupos = [
      {
        id: 0,
